    ...
    <main className="flex min-h-screen flex-col items-center bg-white text-black spac-y-0">
      <section id="first" className="flex space-y-3 items-center min-w-full p-20 flex-col bg-gray-100">
        ...
        <p className="text-center">
          UniProjectは、プログラミング・音楽制作などのデジタル関連の創作活動を行うサークルです。<br />
          活動内容<br />
          Web開発/UTAU/デザイン/競技プログラミング/AI研究/映像制作/インフラ開発(サーバー構築など)/etc...<br />
        </p>
        <Button<"Link"> href="#" disabled={true}>もっと詳しく(準備中)</Button>
      </section>
      ...
      <section id="join" className="flex space-y-3 items-center min-w-full p-20 flex-col bg-gray-100">
        ...
        <div>
          ...
          <Button<"Link"> href="https://forms.gle/VsRQQ4LwnxvDUyH58" disabled={false}>参加フォーム</Button>
        </div>
      </section>
    </main>
  );
